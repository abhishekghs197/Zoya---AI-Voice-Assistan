...
export default function Visualizer({ state, children }: VisualizerProps) {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none">
      ...
      <motion.div
        animate={getPulseAnimation()}
        className={`absolute w-[25%] h-[25%] min-w-[200px] min-h-[200px] rounded-full border-[1px] ${theme.border} bg-black/40 backdrop-blur-md flex items-center justify-center shadow-[inset_0_0_30px_rgba(0,0,0,0.5)]`}
